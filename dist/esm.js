import R__default, { reduce, max, values, dissoc, map as map$1 } from 'ramda';
...
var passprops = function passprops(pass, children) {
  ...
  var propsToChildren = map$1(function (child) {
    return React.cloneElement(child, _objectSpread2({}, pass));
...
var HookForceWrapper = function HookForceWrapper(props) {
  ...
  return React.createElement(HookWrapper, {
    hook: hook,
    forceupdate: setx
  });
};
...
var SvgWrapper = function SvgWrapper(props) {
  ...
  return React.createElement("svg", null, propsToChildren);
};

var HooktoChildren = function HooktoChildren(props) {
  var hook = props.hook ? props.hook() : undefined;
  var propsToChildren = map$1(function (child) {
    return React.cloneElement(child, _objectSpread2({}, props, {
      select: hook
    }));
...
export { HookForceWrapper, HookWrapper, HooktoChildren, SvgWrapper, passAllProps, passExceptChildren, passGivenProps, pickformatter, roundhundth, roundtenth, roundthousth };
